    ...
    export default {
        ...
        watch: {
            ...
            value (v) {
                ...
                this.month = Number(dateArr[1]-1)
                this.date = Number(dateArr[2])
        ...
        ready () {
            if(this.$el.parentNode.offsetWidth + this.$el.parentNode.offsetLeft - this.$el.offsetLeft <= 300){
                this.coordinates = {right: '5', top: `${window.getComputedStyle(this.$el.children[0]).offsetHeight + 4}px`}
            }else{
                this.coordinates = {left: '5', top: `${window.getComputedStyle(this.$el.children[0]).offsetHeight + 4}px`}
            }
        ...
        beforeDestroy () {
            console.log('before ===> ', this.panelState);
            window.removeEventListener('click', this.close)
            console.log('after ===> ', this.panelState);
        }
    }
</script>
